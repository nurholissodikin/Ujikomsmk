...
<div id="page-head">
      ...
      @if(Session::has('alert-success'))
          ...
          <div ><a class="btn btn-primary" href="{{route('jadwal.create')}}"><i class="ti-plus"></i> Tambah Data</a>
              </div>
        <div class="panel">
              <div class="panel-heading">
                  <h3 class="panel-title">Data Jadwal Pelajaran</h3>
              </div>
                   ...
                   @foreach($jadwal as $data)
                        ...
                        <form action="{{route('jadwal.destroy',$data->id)}}" method="post">
                            ...
                            <td>
                             ...
                             <a href="{{route('jadwal.edit',$data->id)}}"  type="submit" class="btn btn-block-small btn-warning"><i class="ti-pencil-alt"></i> Ubah</i></a>
