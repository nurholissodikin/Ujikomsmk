...
<div id="demo-accordion" class="panel-group accordion">
      ...
      <div class="panel">
        <form id="demo-bv-accordion" class="form-horizontal" action="{{route('kelas.update',$kelas->id)}}" method="post" >
        ...
        <div class="panel">
              ...
              <div class="panel-body">
                  ...
                  <div>
                  <input type="text" name="a" class="form-control" required="" value="{{$kelas->nama}}">
                  </div> </div>  
                  ...
                  <option value="{{$data->id}}"  <?php if($data->id ) {echo "selected";} ?>>{{$data->lokasi}}</option>
                  @endforeach
                  </select>
                  </div>   </div>  
