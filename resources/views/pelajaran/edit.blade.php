...
<div id="page-head">
          ...
          <li class="active">Ubah Data Pelajaran</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
...
<div id="demo-accordion" class="panel-group accordion">
      ...
      <div class="panel">
        <form id="demo-bv-accordion" class="form-horizontal" action="{{route('pelajaran.update',$pelajaran->id)}}" method="post" >
           <input type="hidden" name="_method" value="PUT">
              ...
              <div class="panel-body">
                  ...
                  <label class="control_label">KKM</label>
                   <div>
                  <input type="number" name="b" class="form-control" required="" value="{{$pelajaran->kkm}}">
                  </div>
                  </div> 
