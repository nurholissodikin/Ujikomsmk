...
<div id="demo-accordion" class="panel-group accordion">
      ...
      <div class="panel">
        <form id="demo-bv-accordion" class="form-horizontal" action="{{route('jurusan.update',$jurusan->id)}}" method="post" >
        ...
        <div class="panel">
              ...
              <div class="panel-body">
                  ...
                  <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                            ...
                            <div>
                                <input type="text" name="a" placeholder="Nama Jurusan" class="form-control" required="" value="{{$jurusan->nama}}">                              
                            </div>
                  </div>
